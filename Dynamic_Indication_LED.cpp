 ...
 const int zaderjka = 2; // ms
  ...
  //----------------------------------------------- 
  bool Indicator::display(uint32_t chislo)
  {
    switch (countSEG)
    {
    case 2:
    {
       display_segment(1, calculate_zifra(chislo, 2));
       display_segment(2, calculate_zifra(chislo, 1));
       return true;
     }   
     case 4:
     {
       display_segment(1, calculate_zifra(chislo, 4));
       display_segment(2, calculate_zifra(chislo, 3));
       display_segment(3, calculate_zifra(chislo, 2));
       display_segment(4, calculate_zifra(chislo, 1));
       return true;
     }    
     case 6:
     {
       display_segment(1, calculate_zifra(chislo, 6));
       display_segment(2, calculate_zifra(chislo, 5));
       display_segment(3, calculate_zifra(chislo, 4));
       display_segment(4, calculate_zifra(chislo, 3));
       display_segment(5, calculate_zifra(chislo, 2));
       display_segment(6, calculate_zifra(chislo, 1));
       return true; 
     } 
...
{
    uint8_t level = on ? LOW_Level : HIGH_Level; 
    switch (segment)
    {
